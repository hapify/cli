...
/**
 * Export route to list looking for
 */
module.exports = {
    method: 'GET',
    path: '/looking-for',
    config: {
        ...
        description: 'Route to list looking for',
        tags: ['looking-for', 'list']
    },
    handler: async (request) => {
        ...
        // Get looking for list from database
        const cursor = request.server.db.collection('looking_for')
            .find(filter)
            .skip(skip)
