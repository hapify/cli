...
/**
 * Export route to list reason to attend
 */
module.exports = {
    method: 'GET',
    ...
    config: {
        ...
        description: 'Route to list reason to attend',
        tags: ['reason-to-attend', 'list']
    },
    handler: async (request) => {
        ...
        // Get reason to attend list from database
        const cursor = request.server.db.collection('reason_to_attend')
            .find(filter)
            .skip(skip)
