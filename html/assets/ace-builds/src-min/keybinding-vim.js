define('ace/keyboard/vim', [
	...
	function Vt(e) {
		...
		return (
			e.getSelection().length == 1 && (t = Mt(t, e.getCursor('anchor'))),
			t
		);
	}
	function $t(e, t) {
	...
	(y.prototype = {
		...
		(function() {
			...
			v.defineExtension('openDialog', function(n, r, i) {
				...
				if (f)
					i.value &&
						((f.value = i.value), i.select !== !1 && f.select()),
						i.onInput &&
						...
						v.on(f, 'keydown', function(e) {
							if (i && i.onKeyDown && i.onKeyDown(e, f.value, a))
								return;
							if (
								e.keyCode == 27 ||
			...
			findKey: function(e, t, n) {
				...
				function s() {
					if (t == '<Esc>')
						return (
							ut(e),
							r.visualMode ? $t(e) : r.insertMode && qn(e),
							!0
						);
				}
				function o(n) {
	...
	var ht = {
			...
			processSearch: function(e, t, n) {
				...
				function l(t, n, i) {
					...
					s == 'Up' || s == 'Down'
						? ((o = s == 'Up' ? !0 : !1),
						  (n =
								nt.searchHistoryController.nextMatch(n, o) ||
								''),
						  i(n))
						: s != 'Left' &&
						  s != 'Right' &&
			...
			processEx: function(e, t, n) {
				...
				function i(t, n, r) {
					...
					i == 'Up' || i == 'Down'
						? ((s = i == 'Up' ? !0 : !1),
						  (n =
								nt.exCommandHistoryController.nextMatch(n, s) ||
								''),
						  r(n))
						: i == 'Ctrl-U'
						? (v.e_stop(t), r(''))
			...
			evalInput: function(e, t) {
				var n = t.inputState,
					...
					l = Lt(
						t.visualMode ? wt(e, a.anchor) : e.getCursor('anchor')
					),
					c = Lt(f),
					h = Lt(l),
					p,
		...
		pt = {
			...
			goToMark: function(e, t, n, r) {
				...
				if (i) {
					var s = i.find();
					return n.linewise
						? { line: s.line, ch: Qt(e.getLine(s.line)) }
						: s;
				}
				return null;
			},
			...
			delete: function(e, t, n) {
				...
				if (!s.visualBlock) {
					...
					t.linewise &&
						...
						(r = o),
						t.linewise &&
							(r = pt.moveToFirstNonWhiteSpaceCharacter(e, o));
				} else {
					i = e.getSelection();
					var a = vt('', n.length);
			...
			enterInsertMode: function(e, t, n) {
				...
				e.setOption('keyMap', 'vim-insert'),
					...
					nt.macroModeState.isPlaying ||
						(e.on('change', $n),
						v.on(e.getInputField(), 'keydown', Yn)),
					n.visualMode && $t(e),
					It(e, s, o);
			},
	...
	Bn.prototype = {
		...
		parseInput_: function(e, t, n) {
			...
			var r = t.match(/^(\w+)/);
			return (
				r ? (n.commandName = r[1]) : (n.commandName = t.match(/.*/)[0]),
				n
			);
		},
