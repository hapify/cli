...
!(function(e) {
	...
	define('ace/mode/lua/luaparse', ['require', 'exports', 'module'], function(
		e,
		t,
		n
	) {
		(function(e, n, r) {
			...
			function pt(e, t) {
				!t && -1 === w(at, 'name', e.name) && at.push(e),
					(e.isLocal = t);
			}
			function dt(e) {
				return -1 !== b(ot[ut], e);
			...
			function Bt(e, t) {
				...
				var s = St();
				return (
					K('end'), (t = t || !1), m(v.functionStatement(e, r, t, s))
				);
			}
			function jt() {
				var e, t, r;
			...
			function Ut(e) {
				...
				if (rt(k)) {
					bt(), $();
					var i = Ut(8);
					i == null && T('<expression>', k),
						(n = m(v.unaryExpression(t, i)));
				}
