...
!(function(e) {
	...
	define('ace/mode/xml/sax', ['require', 'exports', 'module'], function(
		e,
		t,
		n
	) {
	...
	define('ace/mode/xml/dom', ['require', 'exports', 'module'], function(
		e,
		t,
		n
	) {
		...
		var s = 'http://www.w3.org/1999/xhtml',
			...
			x = (b.HIERARCHY_REQUEST_ERR = ((w[3] = 'Hierarchy request error'),
			3)),
			...
			k = (b.NO_MODIFICATION_ALLOWED_ERR = ((w[7] =
			...
			D = (b.INVALID_MODIFICATION_ERR = ((w[13] = 'Invalid modification'),
			13)),
