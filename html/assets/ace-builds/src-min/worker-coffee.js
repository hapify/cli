...
!(function(e) {
	...
	define('ace/mode/coffee/coffee', ['require', 'exports', 'module'], function(
		require,
		exports,
		module
	) {
								...
								function() {
									...
									(e.starts = function(e, t, n) {
										...
										(e.isCoffee = function(e) {
											return /\.((lit)?coffee|coffee\.md)$/.test(
												e
											);
										}),
										(e.isLiterate = function(e) {
											return /\.(litcoffee|coffee\.md)$/.test(
												e
											);
										}),
										...
										(e.nameWhitespaceCharacter = function(
											e
										) {
											switch (e) {
												case ' ':
										...
										d = function(e, t, n) {
											...
											e.Rewriter = (function() {
												...
												return (
													...
													(e.prototype.scanTokens = function(
														e
													) {
														var t, n, r;
														for (
													...
													(e.prototype.looksObjectish = function(
														e
													) {
														var t, n;
														return this.indexOfTag(
															e,
															'@',
															null,
															':'
													...
													(e.prototype.findTagsBackwards = function(
														e,
														t
													) {
														var n, r, o, u, a, f, l;
											...
											return (
													...
													for (
														...
														if (
															((n =
																...
																this.jsToken() ||
																this.literalToken()),
															(s = this.getLineAndColumnFromChunk(
																n
															)),
															(this.chunkLine =
																s[0]),
												...
												(e.prototype.stringToken = function() {
													...
													if (
														...
														(s = 3 === l.length),
														(c = this.matchWithInterpolations(
															m,
															l
														)),
														(y = c.tokens),
												...
												(e.prototype.regexToken = function() {
													...
													switch (
														...
														case !h &&
															1 !== p.length:
															null == e &&
																(e = this.formatHeregex(
																	p[0][1]
																)),
																this.token(
																	'REGEX',
																	'' +
																		this.makeDelimitedLiteral(
																			e,
																			{
																				delimiter:
																					'/'
												...
												(e.prototype.outdentToken = function(
													e,
													t,
													n
												) {
												...
												(e.prototype.matchWithInterpolations = function(
													...
													for (
														...
														if (
															...
															break;
														(h = this.getLineAndColumnFromChunk(
															l + 1
														)),
															(a = h[0]),
															(i = h[1]),
												...
												(e.prototype.makeToken = function(
													e,
													t,
													n,
													r
													...
													return (
														...
														(u = this.getLineAndColumnFromChunk(
															n + i
														)),
														(s.last_line = u[0]),
														(s.last_column = u[1]),
												...
												(e.prototype.formatString = function(
													e
												) {
													return e.replace(V, '$1');
												}),
												(e.prototype.formatHeregex = function(
													e
												) {
													return e.replace(m, '$1$2');
												}),
												(e.prototype.validateEscapes = function(
													e,
													t
												) {
													var n, r, i, s, o, u, a, f;
								...
								function() {
									...
									e.Scope = t = (function() {
										...
										return (
											...
											(e.prototype.parameter = function(
												e
											) {
												return this.shared &&
													this.parent.check(e, !0)
													? void 0
													: this.add(e, 'param');
											}),
											...
											(e.prototype.temporary = function(
												e,
												t,
												n
											) {
											...
											(e.prototype.freeVariable = function(
												e,
												t
											) {
												var r, i, s;
									...
									(Error.stackTraceLimit = 1 / 0),
										...
										(e.Base = i = (function() {
											...
											return (
												(e.prototype.compile = function(
													...
													return st(
														this.compileToFragments(
															e,
															t
														)
													);
												}),
												(e.prototype.compileToFragments = function(
													e,
													t
												) {
													var n;
												...
												(e.prototype.compileClosure = function(
													e
												) {
													var n, r, i, u, f, l, c;
													return (
												...
												(e.prototype.cacheToCodeFragments = function(
													e
												) {
												...
												(e.prototype.lastNonComment = function(
													e
												) {
													var t;
													for (t = e.length; t--; )
												...
												(e.prototype.traverseChildren = function(
													e,
													t
												) {
												...
												(e.prototype.updateLocationDataIfMissing = function(
													e
												) {
													return this.locationData
														...
														: ((this.locationData = e),
														  this.eachChild(
																function(t) {
																	return t.updateLocationDataIfMissing(
																		e
																	);
																}
														  ));
												...
												(e.prototype.makeCode = function(
													e
												) {
													return new f(this, e);
												}),
												(e.prototype.wrapInBraces = function(
													e
												) {
													return [].concat(
														this.makeCode('('),
												...
												(e.prototype.joinFragmentArrays = function(
													e,
													t
												) {
													var n, r, i, s, o;
										...
										(e.Block = s = (function(e) {
											...
											return (
												...
												(t.prototype.compileToFragments = function(
													e,
													n
												) {
													return (
												...
												(t.prototype.compileRoot = function(
													e
												) {
													var t,
														n,
													...
													return (
														...
														e.bare ||
															...
															(this.expressions = h)),
														(n = this.compileWithDeclarations(
															e
														)),
														e.bare
															? n
											...
											return (
												...
												(t.prototype.compileNode = function(
													...
													return (
														...
														this.expression &&
															(t = t.concat(
																this.expression.compileToFragments(
																	e,
																	C
																)
															)),
										...
										(e.Value = Q = (function(e) {
											...
											return (
												...
												(t.prototype.bareLiteral = function(
													e
												) {
													return (
														!this.properties
												...
												(t.prototype.isSimpleNumber = function() {
													return (
														this.bareLiteral(L) &&
														I.test(this.base.value)
													);
												}),
												(t.prototype.isString = function() {
													return (
														this.bareLiteral(L) &&
														y.test(this.base.value)
													);
												}),
												(t.prototype.isRegex = function() {
													return (
														this.bareLiteral(L) &&
														g.test(this.base.value)
													);
												}),
												(t.prototype.isAtomic = function() {
													var e, t, n, r;
													for (
														r = this.properties.concat(
															this.base
														),
															e = 0,
															t = r.length;
												...
												(t.prototype.looksStatic = function(
													e
												) {
													var t;
													return (
												...
												(t.prototype.cacheReference = function(
													e
												) {
													var n, i, s, o, u;
													return (
										...
										(e.Call = o = (function(e) {
											...
											return (
												...
												(n.prototype.superReference = function(
													e
												) {
													var n, i, s, o, u, a, f, l;
													return (
												...
												(n.prototype.superThis = function(
													e
												) {
													var t;
													return (
												...
												(n.prototype.unfoldSoak = function(
													e
												) {
													var t,
														r,
												...
												(n.prototype.compileNode = function(
													e
												) {
													var t,
														n,
													...
													return (
														...
														this.isSuper
															...
															: (this.isNew &&
															  ...
															  s.push.apply(
																	s,
																	this.variable.compileToFragments(
																		e,
																		S
																	)
															  ),
												...
												(n.prototype.compileSplat = function(
													e,
													t
												) {
													var n, r, i, s, o, u;
										...
										(e.Access = t = (function(e) {
											...
											return (
												...
												(t.prototype.compileToFragments = function(
													...
													var t;
													return (
														(t = this.name.compileToFragments(
															e
														)),
														m.test(st(t))
															? t.unshift(
										...
										(e.Range = j = (function(e) {
											...
											return (
												...
												(t.prototype.compileVariables = function(
													e
												) {
													var t, n, r, i, s, o;
													return (
														...
														(this.toNum = s[1]),
														this.stepVar
															? (this.stepNum = this.stepVar.match(
																	M
															  ))
															: void 0
													);
												...
												(t.prototype.compileArray = function(
													e
												) {
													var t,
														n,
													...
													return this.fromNum &&
														...
														: ((o = this.tab + X),
														  (s = e.scope.freeVariable(
																'i',
																{ single: !0 }
														  )),
														  (c = e.scope.freeVariable(
																'results'
														  )),
														  (a =
																'\n' +
											...
											return (
												...
												(n.prototype.compileNode = function(
													...
													for (
														s = S.length > i,
															u = e.indent += X,
															v = this.lastNonComment(
																this.properties
															),
															n = [],
															s &&
																((w = e.scope.freeVariable(
																	'obj'
																)),
																n.push(
																	this.makeCode(
										...
										(e.Class = u = (function(e) {
											...
											return (
												...
												(n.prototype.determineName = function() {
													...
													return this.variable
														? ((n = this.variable
														  ...
														  St.call(q, e) >= 0 &&
																this.variable.error(
																	'class variable name may not be ' +
																		e
																),
														  e &&
																(e =
												...
												(n.prototype.addBoundFunctions = function(
													e
												) {
													var n, r, i, s, o;
													for (
												...
												(n.prototype.addProperties = function(
													e,
													n,
													i
												) {
																...
																o instanceof
																	...
																	u.value
																		? (this
																		  ...
																		  a
																				? (o = this.ctor = l)
																				: ((this.externalCtor = i.classScope.freeVariable(
																						'class'
																				  )),
																				  (o = new r(
																						new L(
												...
												(n.prototype.hoistDirectivePrologue = function() {
													...
													for (
														...
														++t;
													return (this.directives = e.splice(
														0,
														t
													));
												}),
												(n.prototype.ensureConstructor = function(
													e
												) {
													return (
														this.ctor ||
												...
												(n.prototype.compileNode = function(
													...
													return (
														...
														(this.body.spaced = !0),
														this.body.expressions.push(
															l
														),
														this.parent &&
															((d = new L(
																e.classScope.freeVariable(
																	'superClass',
																	{
																		reserve: !1
																	}
											...
											return (
												...
												(n.prototype.compileNode = function(
													...
													if (
														...
														if (
															this.variable.isSplice()
														)
															return this.compileSplice(
																e
															);
														if (
															'||=' ===
														...
														if (
															...
															return this.compileSpecialMath(
																e
															);
													}
													return (
														...
														(d = this.value.compileToFragments(
															e,
															T
														)),
														(n = this.variable.compileToFragments(
															e,
															T
														)),
														'object' ===
												...
												(n.prototype.compilePatternMatch = function(
													e
												) {
													var r,
														i,
													...
													if (
														((D = e.level === k),
														(j = this.value),
														(y = this.variable.base
															.objects),
														!(b = y.length))
													)
														return (
															(s = j.compileToFragments(
																e
															)),
															e.level >= N
																? this.wrapInBraces(
												...
												(n.prototype.compileConditional = function(
													e
												) {
													var t, r, i, s;
													return (
														(i = this.variable.cacheReference(
															e
														)),
														(r = i[0]),
														(s = i[1]),
												...
												(n.prototype.compileSpecialMath = function(
													e
												) {
													var t, r, i;
													return (
														(r = this.variable.cacheReference(
															e
														)),
														(t = r[0]),
														(i = r[1]),
												...
												(n.prototype.compileSplice = function(
													e
												) {
													var t,
														n,
														...
														h;
													return (
														(u = this.variable.properties.pop()
															.range),
														(r = u.from),
														(l = u.to),
														(n = u.exclusive),
														(o = this.variable.compile(
															e
														)),
														r
										...
										(e.Code = a = (function(e) {
											...
											return (
												...
												(t.prototype.jumps = O),
												(t.prototype.makeScope = function(
													e
												) {
													return new R(
														e,
												...
												(t.prototype.eachParamName = function(
													e
												) {
													var t, n, r, i, s;
													for (
												...
												(t.prototype.traverseChildren = function(
													e,
													n
												) {
													return e
														? t.__super__.traverseChildren.call(
																this,
																e,
																n
														  )
										...
										(e.Param = P = (function(e) {
											...
											return (
												...
												(t.prototype.compileToFragments = function(
													...
													return this.name.compileToFragments(
														e,
														T
													);
												}),
										...
										(e.Splat = z = (function(e) {
											...
											return (
												...
												(t.compileSplattedArray = function(
													e,
													n,
													r
												) {
												...
												(t.prototype.compileNode = function(
													...
													return (
														...
														(t = [].concat(
															...
															this.condition.compileToFragments(
																e,
																C
															),
															this.makeCode(
											...
											return (
												...
												(n.prototype.invert = function() {
													...
													return (i =
														...
														: '!' ===
																this.operator &&
														  (r = this.first.unwrap()) instanceof
																n &&
														  ('!' ===
																(o =
																	r.operator) ||
												...
												(n.prototype.generateDo = function(
													e
												) {
													var t, n, i, s, u, f, l, c;
													for (
												...
												(n.prototype.compileNode = function(
													...
													switch (this.operator) {
														...
														case '//':
															return this.compileFloorDivision(
																e
															);
														case '%%':
															return this.compileModulo(
																e
															);
														default:
															return (
																(r = this.first.compileToFragments(
																	e,
																	N
																)),
																(o = this.second.compileToFragments(
																	e,
																	N
																)),
																(t = [].concat(
												...
												(n.prototype.compileChain = function(
													e
												) {
													var t, n, r, i;
													return (
														(r = this.first.second.cache(
															e
														)),
														(this.first.second =
															r[0]),
														(i = r[1]),
														(n = this.first.compileToFragments(
															e,
															N
														)),
														(t = n.concat(
															...
															this.second.compileToFragments(
																e,
																N
															)
														)),
												...
												(n.prototype.compileExistence = function(
													e
												) {
													var t, n;
													return (
												...
												(n.prototype.compileUnary = function(
													e
												) {
													var t, r, i;
													return (
														...
														this.first instanceof c
															? ((this.first.negated = !this
																	.first
																	.negated),
															  this.first.compileToFragments(
																	e
															  ))
															: e.level >= S
															? new H(
												...
												(n.prototype.compileYield = function(
													e
												) {
													var t, n;
													return (
												...
												(n.prototype.compilePower = function(
													e
												) {
													var n;
													return (
												...
												(n.prototype.compileFloorDivision = function(
													e
												) {
													var r, i;
													return (
												...
												(n.prototype.compileModulo = function(
													e
												) {
													var t;
													return (
										...
										(e.In = w = (function(e) {
											...
											return (
												...
												(t.prototype.compileNode = function(
													...
													var t, n, r, i, s;
													if (
														this.array instanceof
															Q &&
														this.array.isArray() &&
														this.array.base.objects
															.length
													) {
														for (
															s = this.array.base
														...
														if (!t)
															return this.compileOrTest(
																e
															);
													}
													return this.compileLoopTest(
														e
													);
												}),
												(t.prototype.compileOrTest = function(
													e
												) {
													var t,
														n,
												...
												(t.prototype.compileLoopTest = function(
													e
												) {
													var t, n, r, i;
													return (
										...
										(e.Try = J = (function(e) {
											...
											return (
												...
												(t.prototype.compileNode = function(
													...
													return (
														(e.indent += X),
														(s = this.attempt.compileToFragments(
															e,
															k
														)),
														(t = this.recovery
															? ((i = new L(
															  ...
															  [].concat(
																	...
																	this.recovery.compileToFragments(
																		e,
																		k
																	),
																	this.makeCode(
														...
														(n = this.ensure
															? [].concat(
																	...
																	this.ensure.compileToFragments(
																		e,
																		k
																	),
																	this.makeCode(
										...
										(e.For = d = (function(e) {
											...
											return (
												...
												(t.prototype.pluckDirectCall = function(
													e,
													t
												) {
													var n,
													...
													for (
														a = e.indent + X,
															...
															o = [].concat(
																...
																this.subject
																	? this.subject.compileToFragments(
																			e,
																			C
																	  )
																	: this.makeCode(
														...
														this.otherwise &&
															...
															o.push.apply(
																...
																[
																	...
																	xt.call(
																		this.otherwise.compileToFragments(
																			e,
																			k
																		)
																	),
										...
										(e.If = b = (function(e) {
											...
											return (
												...
												(t.prototype.addElse = function(
													e
												) {
													return (
														this.isChain
															? this.elseBodyNode().addElse(
																	e
															  )
															: ((this.isChain =
																	e instanceof
																	t),
															  (this.elseBody = this.ensureBlock(
																	e
															  )),
												...
												(t.prototype.ensureBlock = function(
													e
												) {
												...
												(t.prototype.compileStatement = function(
													e
												) {
													var n, r, i, s, o, u, a;
													return (
												...
												(t.prototype.compileExpression = function(
													e
												) {
													var t, n, r, i;
													return (
														(r = this.condition.compileToFragments(
															e,
															x
														)),
														(n = this.bodyNode().compileToFragments(
															e,
															T
														)),
														(t = this.elseBodyNode()
															? this.elseBodyNode().compileToFragments(
																	e,
																	T
															  )
															: [
								...
								function() {
									...
									(e = (function() {
										...
										return (
											...
											(e.prototype.sourceLocation = function(
												e
											) {
												for (
													var t;
										...
										(n = (function() {
											...
											return (
												...
												(t.prototype.sourceLocation = function(
													e
												) {
													var t, n, r;
													for (
												...
												(r = 1 << i),
												(s = r - 1),
												(t.prototype.encodeVlq = function(
													e
												) {
													var t, n, o, u;
													for (
												...
												(t.prototype.encodeBase64 = function(
													e
												) {
													return (
														n[e] ||
											...
											if (
												...
												if (
													...
													if (
														...
														(s.paths = r.paths = n._nodeModulePaths(
															process.cwd()
														)),
															(s.resolve = function(
																e
															) {
																return n._resolveFilename(
																	e,
																	r
																);
															});
									...
									(e._compileFile = function(e, t) {
													...
													switch (!1) {
														...
														case 'IDENTIFIER' !==
															...
															return r
																...
																.toLowerCase();
														default:
															return f.nameWhitespaceCharacter(
																i
															);
													}
												})()),
										...
										(a = function(t) {
											...
											if (
												...
												!(
													0 >
													w.call(e.FILE_EXTENSIONS, r)
												))
											)
												return (
													(n = e._compileFile(t, !0)),
													(m[t] = n.sourceMap)
												);
										}),
										...
										'undefined' != typeof window &&
											...
											(runScripts = function() {
												var e,
													...
													l;
												for (
													l = window.document.getElementsByTagName(
														'script'
													),
														t = [
															'text/coffeescript',
