				...
				start: [
					{
						...
						onMatch: function(e, t, n) {
							return (
								n.unshift(this.next, e.length - 2, t), 'comment'
							);
						},
						regex: /\-\-\[=*\[/,
						next: [
			...
			function() {
				...
				(this.getNextLineIndent = function(e, t, r) {
					...
					(this.checkOutdent = function(e, n, r) {
						...
						var i = this.getTokenizer().getLineTokens(n.trim(), e)
							.tokens;
						return !i || !i.length
							? !1
							: i[0].type == 'keyword' &&
					...
					(this.autoOutdent = function(e, t, r) {
						var i = t.getLine(r - 1),
							...
							o = this.getTokenizer().getLineTokens(i, 'start')
								.tokens,
