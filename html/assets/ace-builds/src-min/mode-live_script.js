		...
		s = function() {
			(this.$rules = {
				start: [
					{
						...
						push: [
							...
							{
								token:
									'storage.type.annotation.livescriptscript',
								regex: '@\\w*'
							},
				...
				'#constructor_variable': [
					{
						token:
							'variable.other.readwrite.constructor.livescript',
				...
				'#interpolated_livescript': [
					{
						todo: {
							...
							push: [
								{
									token:
										'punctuation.section.embedded.livescript',
									regex: '\\}',
									next: 'pop'
								},
								{ include: '$self' },
								{
									defaultToken:
										'source.livescript.embedded.source'
								}
							]
						}
					},
