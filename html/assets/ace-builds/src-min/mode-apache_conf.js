			...
			(this.$rules = {
				start: [
					...
					},
					{
						...
						regex:
							'\\b(?:AuthAuthoritative|AuthGroupFile|AuthUserFile)\\b'
					},
					{
					...
					},
					{
						...
						regex:
							'\\b(?:ScriptLog|ScriptLogBuffer|ScriptLogLength)\\b'
					},
					{
					...
					},
					{
						...
						regex:
							'\\b(?:CharsetDefault|CharsetOptions|CharsetSourceEnc)\\b'
					},
					{
						token: 'keyword.dav.apacheconf',
						regex:
							'\\b(?:Dav|DavDepthInfinity|DavMinTimeout|DavLockDB)\\b'
					},
					{
					...
					},
					{
						...
						regex:
							'\\b(?:ExpiresActive|ExpiresByType|ExpiresDefault)\\b'
					},
					{
					...
					},
					{
						...
						regex:
							'\\b((?:text|image|application|video|audio)/.+?)(\\s)'
					},
					{
