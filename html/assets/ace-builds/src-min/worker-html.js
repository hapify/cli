				...
				1: [
					function(e, t, n) {
						...
						(l.prototype._inScope = function(e, t) {
							...
							(l.prototype.furthestBlockForFormattingElement = function(
								e
							) {
								var t = null;
								for (
							...
							(l.prototype.remove_openElements_until = function(
								e
							) {
								var t = !1,
									n;
									...
									? ((f = r[y]),
									  c === ';' || !n || (!o(c) && c !== '=')
											? (l.length > y.length &&
											  ...
											  f)
											: (e.unget(l), !1))
									: (t._parseError('expected-named-entity'),
									  e.unget(l),
									  !1);
							}
						}),
					...
					function(e, t, n) {
						...
						(i.prototype.isSpecial = function() {
							return (
								...
								r[this.namespaceURI].indexOf(this.localName) >
									-1
							);
						}),
						...
						(u.prototype._parseError = function(e, t) {
							...
							(u.prototype.tokenize = function(e) {
								...
								function $(e) {
									...
									return (
										(this._currentAttribute().nodeValue +=
											n || '&'),
										this._additionalAllowedCharacter === '"'
											? t.setState(W)
											: this
								...
								var t = this;
								while (
									this._state.call(this, this._inputStream)
								);
							}),
							...
							(t.base = {
								...
								processStartTag: function(e, t, n) {
									if (this[this.start_tag_handlers[e]])
										this[this.start_tag_handlers[e]](
											e,
											t,
											n
										);
										...
										if (
											...
											throw new Error(
												'No handler found for ' + e
											);
										this[
											this.start_tag_handlers['-default']
										](e, t, n);
									}
								},
								processEndTag: function(e) {
									if (this[this.end_tag_handlers[e]])
										...
										this[this.end_tag_handlers['-default']](
											e
										);
									}
								},
								...
								(t.initial.processDoctype = function(
									t,
									n,
									r,
									i
								...
								(t.initial.processStartTag = function(t, n, r) {
									e.parseError(
										...
										this.anythingElse(),
										e.insertionMode.processStartTag(
											t,
											n,
											r
										);
								...
								(t.beforeHTML.startTagOther = function(
									t,
									n,
									r
								) {
								...
								(t.afterAfterBody.startTagHtml = function(
									e,
									n
								) {
									t.inBody.startTagHtml(e, n);
								}),
								(t.afterAfterBody.startTagOther = function(
									t,
									n,
									r
								) {
								...
								(t.afterAfterBody.processCharacters = function(
									n
								) {
									if (!p(n.characters))
										return (
								...
								(t.afterBody.processStartTag = function(
									t,
									n,
									r
								) {
								...
								(t.afterFrameset.processCharacters = function(
									t
								) {
								...
								(t.afterFrameset.startTagNoframes = function(
									e,
									n
								) {
									t.inHead.processStartTag(e, n);
								}),
								(t.afterFrameset.startTagOther = function(
									t,
									n
								) {
									e.parseError(
								...
								(t.beforeHead.startTagOther = function(
									t,
									n,
									r
								) {
								...
								(t.inHead.startTagNoScript = function(t, n) {
									if (e.scriptingEnabled)
										return e.processGenericRawTextStartTag(
											t,
											n
										);
									e.insertElement(t, n),
								...
								(t.inHead.startTagNoFramesStyle = function(
									t,
									n
								) {
								...
								(t.inHead.startTagScript = function(t, n) {
									e.insertElement(t, n),
										...
										(e.originalInsertionMode =
											e.insertionModeName),
										e.setInsertionMode('text');
								}),
								(t.inHead.startTagBaseBasefontBgsoundLink = function(
									t,
									n
								) {
								...
								(t.afterHead.startTagFromHead = function(
									n,
									r,
									i
								) {
								...
								(t.inBody.processCharacters = function(t) {
									...
									n = n.replace(/\u0000/g, function(t, n) {
										return (
											e.parseError('invalid-codepoint'),
											''
										);
									});
									if (!n) return;
								...
								(t.inBody.startTagHtml = function(t, n) {
									e.parseError('non-html-root'),
										e.addAttributesToElement(
											e.openElements.rootNode,
											n
										);
								}),
								(t.inBody.startTagProcessInHead = function(
									e,
									n
								) {
									t.inHead.processStartTag(e, n);
								...
								(t.inBody.startTagBody = function(t, n) {
									e.parseError('unexpected-start-tag', {
										...
										e.openElements.length == 1 ||
										e.openElements.item(1).localName !=
											'body'
											? r.ok(e.context)
											: ((e.framesetOk = !1),
											  e.addAttributesToElement(
								...
								(t.inBody.startTagA = function(t, n) {
									var r = e.elementInActiveFormattingElements(
										'a'
									);
									r &&
										(e.parseError(
										...
										e.openElements.contains(r) &&
											e.openElements.remove(r),
										e.removeElementFromActiveFormattingElements(
											r
										)),
										e.reconstructActiveFormattingElements(),
								...
								(t.inBody.startTagAppletMarqueeObject = function(
									t,
									n
								) {
									e.reconstructActiveFormattingElements(),
								...
								(t.inBody.endTagAppletMarqueeObject = function(
									t
								) {
								...
								(t.inBody.startTagVoidFormatting = function(
									t,
									n
								) {
									e.reconstructActiveFormattingElements(),
								...
								(t.inBody.startTagParamSourceTrack = function(
									t,
									n
								) {
									e.insertSelfClosingElement(t, n);
								...
								(t.inBody.startTagInput = function(t, n) {
									...
									for (var i in n)
										if (n[i].nodeName == 'type') {
											n[i].nodeValue.toLowerCase() ==
												'hidden' && (e.framesetOk = r);
											break;
										}
								}),
								...
								(t.inBody.startTagOptionOptgroup = function(
									t,
									n
								) {
									e.currentStackItem().localName ==
								...
								(t.inBody.endTagBody = function(t) {
									...
									e.currentStackItem().localName != 'body' &&
										e.parseError(
											...
											{
												expectedName: e.currentStackItem()
													.localName,
												gotName: t
											}
										),
								...
								(t.inBody.endTagHeading = function(t) {
									...
									e.generateImpliedEndTags(),
										e.currentStackItem().localName != t &&
											e.parseError('end-tag-too-early', {
												name: t
											}),
										e.openElements.remove_openElements_until(
											function(e) {
								...
								(t.inBody.endTagFormatting = function(t, n) {
									e.adoptionAgencyEndTag(t) ||
										this.endTagOther(t, n);
								}),
								...
								(t.inCaption.startTagTableElement = function(
									t,
									n
								) {
									e.parseError('unexpected-end-tag', {
									...
									var r = !e.openElements.inTableScope(
										'caption'
									);
								...
								(t.inCaption.endTagTable = function(t) {
									...
									var n = !e.openElements.inTableScope(
										'caption'
									);
									e.insertionMode.processEndTag('caption'),
								...
								(t.inCell.startTagTableOther = function(
									t,
									n,
									r
								) {
								...
								(t.inColumnGroup.processCharacters = function(
									t
								) {
									var n = t.takeLeadingWhitespace();
									n && e.insertText(n);
									...
									this.endTagColgroup('colgroup'),
										r ||
											e.insertionMode.processCharacters(
												t
											);
								}),
								...
								(t.inColumnGroup.startTagOther = function(
									t,
									n,
									r
								) {
								...
								(t.inForeignContent.processStartTag = function(
									t,
									n,
									r
								) {
								...
								(t.inForeignContent.processEndTag = function(
									t
								) {
								...
								(t.inForeignContent.processCharacters = function(
									t
								) {
									var n = t.takeRemaining();
									(n = n.replace(/\u0000/g, function(t, n) {
								...
								(t.inHeadNoscript.start_tag_handlers = {
									html: 'startTagHtml',
									basefont:
										'startTagBasefontBgsoundLinkMetaNoframesStyle',
									bgsound:
										'startTagBasefontBgsoundLinkMetaNoframesStyle',
									link:
										'startTagBasefontBgsoundLinkMetaNoframesStyle',
								...
								(t.inHeadNoscript.processCharacters = function(
									t
								) {
									var n = t.takeLeadingWhitespace();
									n && e.insertText(n);
								...
								(t.inHeadNoscript.startTagHeadNoscript = function(
									t,
									n
								) {
									e.parseError(
								...
								(t.inHeadNoscript.startTagOther = function(
									t,
									n
								) {
									e.parseError(
								...
								(t.inHeadNoscript.endTagNoscript = function(
									t,
									n
								) {
									e.popElement(),
								...
								(t.inFrameset.startTagFrameset = function(
									t,
									n
								) {
									e.insertElement(t, n);
								...
								(t.inFrameset.startTagNoframes = function(
									e,
									n
								) {
									t.inBody.processStartTag(e, n);
								...
								(t.inTable.processCharacters = function(n) {
									if (
										e.currentStackItem().isFosterParenting()
									) {
										var r = e.insertionModeName;
								...
								(t.inTable.startTagStyleScript = function(
									e,
									n
								) {
									t.inHead.processStartTag(e, n);
								...
								(t.inTableText.processStartTag = function(
									t,
									n,
									r
								) {
								...
								(t.inTableBody.startTagTableCell = function(
									t,
									n
								) {
									e.parseError(
								...
								(t.inTableBody.startTagTableOther = function(
									t,
									n
								) {
								...
								(t.inTableBody.endTagTableRowGroup = function(
									t
								) {
									e.openElements.inTableScope(t)
										? (e.openElements.popUntilTableBodyScopeMarker(),
								...
								(t.inSelectInTable.processCharacters = function(
									e
								) {
									t.inSelect.processCharacters(e);
								}),
								(t.inSelectInTable.startTagTable = function(
									t,
									n
								) {
									e.parseError(
								...
								(t.inSelectInTable.startTagOther = function(
									e,
									n,
									r
								) {
								...
								(t.afterAfterFrameset.processComment = function(
									t
								) {
									e.insertComment(t, e.document);
								}),
								(t.afterAfterFrameset.processCharacters = function(
									t
								) {
									var n = t.takeRemaining(),
										r = '';
								...
								(t.afterAfterFrameset.startTagNoFrames = function(
									e,
									n
								) {
									t.inHead.processStartTag(e, n);
								}),
								(t.afterAfterFrameset.startTagOther = function(
									t,
									n,
									r
								) {
								...
								(t.afterAfterFrameset.processEndTag = function(
									t,
									n
								) {
									e.parseError(
						...
						(m.prototype.skipAtMostOneLeadingNewline = function() {
							...
							(g.prototype.adoptionAgencyEndTag = function(e) {
								...
								var t = 8,
									...
									s = 0;
								while (s++ < t) {
									r = this.elementInActiveFormattingElements(
										e
									);
									if (
										!r ||
										(this.openElements.contains(r) &&
											!this.openElements.inScope(
												r.localName
											))
									)
										return (
									...
									var u = this.openElements.elements.indexOf(
											r
										),
										a = this.openElements.item(u - 1),
										l = this.activeFormattingElements.indexOf(
											r
										),
										c = o,
										h = o,
										p = this.openElements.elements.indexOf(
											c
										),
										d = 0;
									while (d++ < n) {
										...
										if (
											this.activeFormattingElements.indexOf(
												c
											) < 0
										) {
										...
										(this.activeFormattingElements[
											...
											(this.openElements.elements[
												this.openElements.elements.indexOf(
													c
												)
											] = m),
											(c = m),
							...
							(g.prototype.attachNodeToFosterParent = function(
								e,
								t,
								n
							) {
							...
							(g.prototype.addAttributesToElement = function(
								e,
								t
							) {
								throw new Error('Not implemented');
							...
							(g.prototype.insertHeadElement = function(e) {
								...
								return (
									...
									this.attachNode(
										t,
										this.openElements.top.node
									),
									this.openElements.pushHeadElement(
										this.head
									),
									t
								);
							...
							(g.prototype.insertFormattingElement = function(
								e,
								t
							) {
								this.insertElement(
							...
							(g.prototype.insertSelfClosingElement = function(
								e,
								t
							) {
							...
							(g.prototype.insertForeignElement = function(
								e,
								t,
								n,
								r
							...
							(g.prototype.removeElementFromActiveFormattingElements = function(
								...
								var t = this.activeFormattingElements.indexOf(
									e
								);
								t >= 0 &&
									this.activeFormattingElements.splice(t, 1);
							}),
							(g.prototype.elementInActiveFormattingElements = function(
								e
							) {
							...
							(g.prototype.resetInsertionMode = function() {
								var e = !1,
									t = null;
								for (
									var n = this.openElements.length - 1;
									n >= 0;
									n--
								) {
							...
							(g.prototype.processGenericRCDATAStartTag = function(
								e,
								t
							) {
							...
							(g.prototype.processGenericRawTextStartTag = function(
								e,
								t
							) {
								this.insertElement(e, t),
						...
						r.inherits(s, i),
							...
							(s.prototype.insertText = function(e) {
								if (
									...
									var t = this.openElements.findIndex(
											'table'
										),
							...
							(s.prototype.attachNodeToFosterParent = function(
								e,
								t,
								n
							) {
							...
							(s.prototype.getFragment = function() {
								...
								return (
									this.reparentChildren(
										this.openElements.rootNode,
										e
									),
									e
								);
							}),
							(s.prototype.addAttributesToElement = function(
								e,
								t
							) {
				...
				11: [
					function(e, t, n) {
						...
						(r.prototype.parse = function(e) {
							...
							(r.prototype.ignorableWhitespace = function(
								e,
								t,
								n,
								r
								...
								(this.locatorDelegate = r),
									this.contentHandler.ignorableWhitespace(
										e,
										t,
										n
									);
							}),
							(r.prototype.processingInstruction = function(
								e,
								t,
								n
							) {
							...
							(r.prototype.startElement = function(
								e,
								t,
								n,
								r,
							...
							(r.prototype.startPrefixMapping = function(
								e,
								t,
								n
							) {
					...
					function(e, t, n) {
						...
						function m(e, t, n, i) {
							...
							(i =
								...
								e &&
									!s &&
									l(s, n, 'Missing expected exception' + i),
								!e &&
									v(s, n) &&
						...
						(o.AssertionError = function(t) {
							...
							(o.notDeepEqual = function(t, n, r) {
								h(t, n) &&
									l(t, n, r, 'notDeepEqual', o.notDeepEqual);
							}),
				...
				(this.setOptions = function(e) {
					...
					(this.onUpdate = function() {
						...
						(t.contentHandler = {
							...
							this.context
								? t.parseFragment(e, this.context)
								: t.parse(e),
