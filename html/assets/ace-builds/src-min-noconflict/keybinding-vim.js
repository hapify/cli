ace.define(
	...
	function(e, t, n) {
		...
		function N(e, t) {
			this == v.keyMap.vim &&
				v.rmClass(e.getWrapperElement(), 'cm-fat-cursor'),
				(!t || t.attach != C) && T(e);
		}
		function C(e, t) {
			this == v.keyMap.vim &&
		...
		function O(e) {
			...
			return r
				? (X(n) && (t[t.length - 1] = n.toLowerCase()),
				  '<' + t.join('-') + '>')
				: !1;
		}
		function M(e) {
		...
		function K(e, t, n, r, i) {
			...
			n || (n = 'string'),
				(J[e] = { type: n, defaultValue: t, callback: i });
		...
		function Vt(e) {
			...
			return (
				e.getSelection().length == 1 &&
					(t = Mt(t, e.getCursor('anchor'))),
				t
			);
		}
		function $t(e, t) {
		...
		function Zt(e, t) {
			(nt.lastCharacterSearch.increment = e),
				...
				(nt.lastCharacterSearch.selectedCharacter =
					t.selectedCharacter);
		}
		function nn(e, t, n, r) {
			...
			e.openDialog
				? e.openDialog(t, r, {
						...
						onClose: function() {
							e.state.vim &&
								((e.state.vim.status = ''),
								e.ace.renderer.$loop.schedule(
									e.ace.renderer.CHANGE_CURSOR
								));
						}
				  })
				: r(prompt(n, ''));
		...
		function yn(e, t) {
			...
			for (var i = 0; i < n.length; i++)
				typeof n[i] == 'number' &&
					r.push(e.substring(n[i] + 1, n[i + 1]));
			return r;
		}
		function bn(e, t) {
			t || (t = '/');
		...
		function zn(e) {
			...
			i || (e.off('change', Qn), v.off(e.getInputField(), 'keydown', tr)),
				!i &&
				...
				e.operation(function() {
					e.ace.forEachSelection(function() {
						...
						(s = St(s, 0, a)),
							...
							(r = or(e, t, n)),
							(i.$desiredColumn =
								e.state.vim.lastHPos == -1
									? null
									: e.state.vim.lastHPos),
							e.virtualSelectionMode() && (e.state.vim = ur(o));
					}),
						e.curOp.cursorActivity &&
							!r &&
							(e.curOp.cursorActivity = !1);
				}, !0);
			}
			return r && !i.visualMode && !i.insert && Zn(e, i), r;
		}
		function lr(e, t) {
			t.off('beforeEndOperation', lr);
			var n = t.state.cm.vimCmd;
			n && t.execCommand(n.exec ? n : n.name, n.args),
				(t.curOp = t.prevOp);
		}
		var i = e('../range').Range,
		...
		var v = function(e) {
			(this.ace = e),
				...
				(this.onBeforeEndOperation = this.onBeforeEndOperation.bind(
					this
				)),
			...
			function() {
				u.implement(v.prototype, s),
					...
					(this.onBeforeEndOperation = function() {
						...
						e &&
							...
							e &&
								e.cursorActivity &&
								this.signal('cursorActivity', null, e),
							(this.curOp = null));
					}),
					...
					(this.setSelections = function(e, t) {
						var n = this.ace.multiSelect,
							r = e.map(function(e) {
								...
								return (
									(r.cursor = i.comparePoints(r.start, n)
										? r.end
										: r.start),
									r
								);
					...
					(this.clipPos = function(e) {
						var t = this.ace.session.$clipPositionToDocument(
							e.line,
							e.ch
						);
						return g(t);
				...
				(e.prototype.clear = function() {
					...
					(this.findPosV = function(e, t, n, r) {
						...
						if (n == 'line') {
							var o = this.ace.session.documentToScreenPosition(
								e.line,
								e.ch
							);
							r != null && (o.column = r),
					...
					(this.charCoords = function(e, t) {
						if (t == 'div' || !t) {
							var n = this.ace.session.documentToScreenPosition(
								e.line,
								e.ch
							);
						...
						if (t == 'local') {
							var r = this.ace.renderer,
								n = this.ace.session.documentToScreenPosition(
									e.line,
									e.ch
								),
					...
					(this.coordsChar = function(e, t) {
						...
						if (t == 'local') {
							var r = Math.max(
									0,
									Math.floor(e.top / n.lineHeight)
								),
								i = Math.max(
									0,
									Math.floor(e.left / n.characterWidth)
								),
					...
					(this.scrollTo = function(e, t) {
						var n = this.ace.renderer,
							...
							i = r.maxHeight;
						(i -=
							(n.$size.scrollerHeight - n.lineHeight) *
							n.$scrollPastEnd),
							t != null &&
								this.ace.session.setScrollTop(
									Math.max(0, Math.min(t, i))
								),
							e != null &&
				...
				(this.setOption = function(e, n) {
					...
					(this.toggleOverwrite = function(e) {
						return (
							(this.state.overwrite = e), this.ace.setOverwrite(e)
						);
					}),
					...
					(this.getTokenTypeAt = function(e) {
						...
						return t && /comment|string/.test(t.type)
							? 'string'
							: '';
					}),
					...
					(this.indentLine = function(e, t) {
						t === !0
							...
							: t === !1 &&
							  this.ace.session.outdentRows(new i(e, 0, e, 0));
					}),
			...
			(function() {
				...
				v.defineExtension('openDialog', function(n, r, i) {
					...
					if (f)
						i.value &&
							((f.value = i.value),
							i.selectValueOnOpen !== !1 && f.select()),
							i.onInput &&
				...
				findKey: function(e, t, n) {
					...
					function s() {
						if (t == '<Esc>')
							return (
								ut(e),
								r.visualMode ? $t(e) : r.insertMode && zn(e),
								!0
							);
					}
					function o(n) {
					...
					function u() {
						if (s()) return !0;
						var n = (r.inputState.keyBuffer =
								r.inputState.keyBuffer + t),
							i = t.length == 1,
					...
					function a() {
						...
						return (
							o[1] &&
								o[1] != '0' &&
								r.inputState.pushRepeatDigit(o[1]),
							a.command
						);
					}
					var r = tt(e),
		...
		var ht = {
				...
				processAction: function(e, t, n) {
					var r = t.inputState,
						...
						o = Et(n.actionArgs) || {};
					r.selectedCharacter &&
						(o.selectedCharacter = r.selectedCharacter),
				...
				processSearch: function(e, t, n) {
					...
					function l(t, n, i) {
						...
						s == 'Up' || s == 'Down'
							? ((o = s == 'Up' ? !0 : !1),
							  ...
							  (n =
									nt.searchHistoryController.nextMatch(
										n,
										o
									) || ''),
							  i(n),
					...
					switch (n.searchArgs.querySrc) {
						...
						case 'wordUnderCursor':
							...
							if (!d) return;
							var p = e
								.getLine(d.start.line)
								.substring(d.start.ch, d.end.ch);
							m && i ? (p = '\\b' + p + '\\b') : (p = Bt(p)),
					...
					function i(t, n, r) {
						...
						i == 'Up' || i == 'Down'
							? (v.e_stop(t),
							  ...
							  (n =
									nt.exCommandHistoryController.nextMatch(
										n,
										s
									) || ''),
							  r(n),
				...
				evalInput: function(e, t) {
					var n = t.inputState,
						...
						a = t.sel,
						f = Lt(
							t.visualMode ? wt(e, a.head) : e.getCursor('head')
						),
						l = Lt(
							t.visualMode
								? wt(e, a.anchor)
					...
					n.selectedCharacter &&
						(i.selectedCharacter = o.selectedCharacter =
							n.selectedCharacter),
						(i.repeat = v),
						ut(e);
					if (r) {
						...
						if (i.toJumplist) {
							!s &&
								e.ace.curOp != null &&
								(e.ace.curOp.command.scrollIntoView =
									'center-animate');
							var g = nt.jumpList,
								y = g.cachedCursor;
							y
								? (Yt(e, y, m), delete g.cachedCursor)
								: Yt(e, f, m);
						}
			...
			pt = {
				...
				jumpToMark: function(e, t, n, r) {
					...
					return (
						n.linewise && (i = E(i.line, Qt(e.getLine(i.line)))), i
					);
				},
				...
				moveByLines: function(e, t, n, r) {
					...
					var o = n.repeat + (n.repeatOffset || 0),
						...
						f = e.lastLine();
					if (u < a && i.line == a)
						return this.moveToStartOfLine(e, t, n, r);
				...
				moveToCharacter: function(e, t, n) {
					var r = n.repeat;
					return (
						Zt(0, n), on(e, r, n.forward, n.selectedCharacter) || t
					);
				},
				...
				moveToEol: function(e, t, n, r) {
					...
					var s = E(i.line + n.repeat - 1, Infinity),
						o = e.clipPos(s);
					return (
						o.ch--, (r.lastHSPos = e.charCoords(o, 'div').left), s
					);
				},
			...
			mt = {
				change: function(e, t, n) {
					var r,
						i,
						s = e.state.vim;
					nt.macroModeState.lastInsertModeChanges.inVisualBlock =
						s.visualBlock;
					if (!s.visualMode) {
						var o = n[0].anchor,
							u = n[0].head;
				...
				delete: function(e, t, n) {
					...
					if (!s.visualBlock) {
						...
						t.linewise &&
							...
							(r = o),
							t.linewise &&
								(r = pt.moveToFirstNonWhiteSpaceCharacter(
									e,
									o
								));
					} else {
			...
			yt = {
					...
					if (t.forward)
						...
						l < f.bottom
							? ((a.line -= (f.bottom - l) / i),
							  ...
							  e.scrollTo(
									null,
									f.bottom - e.getScrollInfo().clientHeight
							  ))
							: e.scrollTo(null, u);
					}
				},
				...
				enterInsertMode: function(e, t, n) {
					...
					e.setOption('disableInput', !1),
						...
						nt.macroModeState.isPlaying ||
							(e.on('change', Qn),
							v.on(e.getInputField(), 'keydown', tr)),
						n.visualMode && $t(e),
						It(e, s, o);
				},
				...
				paste: function(e, t, n) {
					...
					if (n.visualMode) {
						...
						n.lastSelection &&
							(y = n.lastSelection.headMark.find()),
				...
				incrementNumberToken: function(e, t) {
					...
					a = p.toString(h);
					var d = f
						? new Array(l.length - a.length + 1 + s[1].length).join(
								'0'
						  )
						: '';
					a.charAt(0) === '-'
		...
		var qn = {
				...
				global: function(e, t) {
					...
					var r = t.line !== undefined ? t.line : e.firstLine(),
						...
						u;
					s.length &&
						((o = s[0]), (u = s.slice(1, s.length).join('/')));
					if (o)
						try {
							Mn(e, o, !0, !0);
						} catch (a) {
		...
		(t.handler = {
			...
			attach: function(e) {
				...
				(e.state.cm = t),
					...
					n(),
					(e.renderer.$cursorLayer.drawCursor = this.drawCursor.bind(
						t
					));
			},
			detach: function(e) {
