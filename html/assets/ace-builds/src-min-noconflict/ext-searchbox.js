			...
			(this.setEditor = function(e) {
				...
				this.$searchBarKb.addCommands([
					...
					},
					{
						...
						exec: function(e) {
							(e.caseSensitiveOption.checked = !e
								.caseSensitiveOption.checked),
								e.$syncOptions();
						}
					},
					{
						...
						exec: function(e) {
							(e.wholeWordOption.checked = !e.wholeWordOption
								.checked),
								e.$syncOptions();
						}
					},
					{
						name: 'toggleReplace',
						exec: function(e) {
							(e.replaceOption.checked = !e.replaceOption
								.checked),
								e.$syncOptions();
						}
					},
				...
				(this.$syncOptions = function(e) {
					r.setCssClass(
						...
						(this.replaceOption.textContent = this.replaceOption
							.checked
							? '-'
							: '+'),
						r.setCssClass(
				...
				(this.updateCounter = function() {
					...
					if (t) {
						var i = this.searchRange
								...
								: e.getValue(),
							s = e.session.doc.positionToIndex(
								e.selection.anchor
							);
						this.searchRange &&
							(s -= e.session.doc.positionToIndex(
