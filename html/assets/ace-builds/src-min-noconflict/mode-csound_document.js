ace.define(
			...
			function() {
				(this.pushRule = function(e) {
					return {
						...
						get next() {
							return Array.isArray(e.next)
								? e.next[e.next.length - 1]
								: e.next;
						},
						set next(t) {
							if (Array.isArray(e.next)) {
						...
						start: [
							{
								...
								onMatch: function(e, t, n) {
									return (
										n.unshift(this.next, e.length - 2, t),
										'comment'
									);
								},
								regex: /\-\-\[=*\[/,
							...
							{ token: 'comment', regex: '\\-\\-.*$' },
							{
								...
								onMatch: function(e, t, n) {
									return (
										n.unshift(this.next, e.length, t),
										'string.start'
									);
								},
								regex: /\[=*\[/,
		...
		function(e, t, n) {
			...
			var r = e('../lib/lang'),
				...
				s = e('./csound_preprocessor_highlight_rules')
					.CsoundPreprocessorHighlightRules,
				o = e('./csound_score_highlight_rules')
				...
				f = function() {
					...
					(e = r.arrayToMap(e)),
						...
						(this.lineContinuations = [
							{
								token:
									'constant.character.escape.line-continuation.csound',
								regex: /\\$/
							},
							this.pushRule({
								token:
										...
										a
											? o[2]
												? [
														...
														{
															type:
																'type-annotation.storage.type.csound',
															value: o[3]
														}
												  ]
												: a
	...
	ace.define(
		...
		function(e, t, n) {
			'use strict';
			var r = e('../lib/oop'),
				i = e('./csound_orchestra_highlight_rules')
					.CsoundOrchestraHighlightRules,
				s = e('./csound_score_highlight_rules')
					.CsoundScoreHighlightRules,
	...
	ace.define(
		...
		function(e, t, n) {
			...
			var r = e('../lib/oop'),
				i = e('./text').Mode,
				s = e('./csound_document_highlight_rules')
					.CsoundDocumentHighlightRules,
				o = function() {
