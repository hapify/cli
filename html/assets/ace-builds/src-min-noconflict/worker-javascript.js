...
!(function(e) {
						...
						(function(e) {
							(function() {
								...
								var r,
									...
									j = {};
								(j[w] = j[E] = j[S] = j[x] = j[T] = j[N] = j[
									C
								] = j[k] = j[L] = !0),
									(j[o] = j[u] = j[b] = j[a] = j[f] = j[
										l
									] = j[c] = j[h] = j[p] = j[d] = j[v] = j[
										m
									] = j[g] = j[y] = !1);
								var F = {};
								(F[o] = F[u] = F[b] = F[a] = F[f] = F[w] = F[
									E
								] = F[S] = F[x] = F[T] = F[p] = F[d] = F[v] = F[
									g
								] = F[N] = F[C] = F[k] = F[L] = !0),
						...
						var r = e('../lodash'),
							...
							p = (function() {
									...
									return (
										...
										t
											...
											: f.tokens.next.id === '(number)' &&
											  ((t = f.tokens.next.value.toString()),
											  n || V()),
								...
								var an = function() {
									...
									vn = function() {
										function i(e) {
											var t = n.variables.filter(function(
												t
											) {
												if (t.value === e)
													return (t.undef = !1), e;
													...
													if (r.length === 2)
														switch (r[0]) {
															case 'ignore':
																switch (r[1]) {
																	case 'start':
																		(o.ignoringLinterErrors = !0),
																			(i = !1);
																		break;
																	case 'end':
																		(o.ignoringLinterErrors = !1),
																			(i = !1);
																}
														}
													a = n;
					...
					function(e, t, n) {
						...
						var r = e('../lodash'),
							i = {
								...
								E047: null,
								E048:
									'{a} declaration not directly within block.',
								...
								E053:
									'Export declaration must be in global scope.',
								E054:
							...
							s = {
								...
								W133:
									'Invalid for-{a} loop left-hand-side: {b}.',
								W134:
	...
	ace.define('ace/mode/javascript_worker', [], function(
		require,
		exports,
		module
	) {
