					...
					function Q(e, t, n) {
						...
						var s = function(e) {
							...
							if (r == 0) o = c.up;
								...
								(o = c.right), (u = h.option);
							else if (s > C || (s == C && C != N && r == s))
								o = c.right;
							r !== s && (u |= h.shift),
								o &&
									(t.onCommandKey(null, u, o),
									(N = r),
									(C = s),
									A(''));
						};
							...
							(r.end.row = r.start.row),
								...
								g.useTextareaForIME
									? ((n.value = ''),
									  ...
									  (C = 0))
									: (n.msGetInputContext &&
											(g.context = n.msGetInputContext()),
									  n.getInputContext &&
											(g.context = n.getInputContext()));
						},
						U = function() {
					...
					r.implement(this, u),
						...
						(this.highlight = function(e) {
							if (!this.$searchHighlight) {
								...
								this.$searchHighlight = this.addDynamicMarker(
									t
								);
							}
			...
			var r = e('./lib/oop'),
				...
				w = function(e, t, n) {
					...
					(this.container = r),
						...
						(this.$historyTracker = this.$historyTracker.bind(
							this
						)),
			...
			r.inherits(f, a),
				function() {
					(this.classSuffix = '-v'),
						...
						(this.setInnerHeight = this.setScrollHeight = function(
							e
						) {
							(this.scrollHeight = e),
								e > u
					...
					(this.$computeLayerConfig = function() {
						...
						var d = this.scrollTop % this.lineHeight,
							...
							m = Math.max(
								0,
								Math.round(
									(this.scrollTop - d) / this.lineHeight
								)
							),
							g = m + v,
							y,
		...
		function(e, t, n) {
			...
			function m(e) {
				...
				(e.$onAddRange = e.$onAddRange.bind(e)),
					...
					(e.$checkMultiselectChange = e.$checkMultiselectChange.bind(
						e
					)),
