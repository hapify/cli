				...
				(this.$rules = {
					start: [
						...
						},
						{
							...
							regex:
								':-\\send_(?:object|protocol|category)(?=[.])'
						},
						{
							caseInsensitive: !1,
						...
						},
						{
							...
							regex:
								'\\b(?:(?:create|current|set)_logtalk_flag|halt)(?=[(])'
						},
						{
							token:
								'support.function.implementation-defined-hooks.logtalk',
						...
						},
						{
							...
							regex:
								'\\b(?:context|parameter|se(?:lf|nder)|this)(?=[(])'
						},
						{
						...
						{
							token:
								'support.function.message-forwarding-handler.logtalk',
							regex: '\\b(forward)(?=[(])'
						},
						{
