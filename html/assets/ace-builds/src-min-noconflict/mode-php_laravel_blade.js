ace.define(
				...
				s = function() {
					...
					var e = {
							...
							comments: [
								{
									token:
										'punctuation.definition.comment.blade',
									regex: '(\\/\\/(.)*)|(\\#(.)*)',
									next: 'pop'
								},
								{
							...
							directives: [
								...
								},
								{
									...
									push: [
										{
											token:
												'injections.unescaped.end.blade',
											regex: '\\!\\!\\}',
											next: 'pop'
										},
										{ include: 'strings' },
							...
							strings: [
								{
									...
									push: [
										...
										{
											token:
												'string.character.escape.blade',
											regex: '\\\\.'
										},
										{
											defaultToken:
												'string.quoted.single.blade'
										}
									]
								},
								{
	...
	ace.define(
		...
		function(e, t, n) {
			'use strict';
			var r = e('../lib/oop'),
				i = e('./php_laravel_blade_highlight_rules')
