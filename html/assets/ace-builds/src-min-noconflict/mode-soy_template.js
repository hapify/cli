ace.define(
				...
				s = function() {
					...
					var e = {
						...
						'#css': [
							{
								...
								push: [
									...
									},
									{
										...
										regex:
											'\\b(?:LITERAL|REFERENCE|BACKEND_SPECIFIC|GOOG)\\b'
									},
						...
						'#attribute-lookup': [
							{
								token:
									'punctuation.definition.attribute-lookup.begin.soy',
								regex: '\\[',
								push: [
									{
										token:
											'punctuation.definition.attribute-lookup.end.soy',
										regex: '\\]',
										next: 'pop'
									},
									{ include: '#variable' },
						...
						'#tag-simple': [
							{
								...
								regex:
									'{{\\s*(?:literal|else|ifempty|default)\\s*(?=\\})'
							}
						],
						'#template': [
							{
	...
	ace.define(
		...
		function(e, t, n) {
			...
			var r = e('../lib/oop'),
				i = e('./html').Mode,
				s = e('./soy_template_highlight_rules')
