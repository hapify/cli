	...
	ace.define(
		...
		function(e, t, n) {
			...
			var r = e('../../lib/oop'),
				...
				f = function() {
					s.call(this),
						this.add('autoBraceTagClosing', 'insertion', function(
							e,
							t,
							n,
							r,
							...
							if (i == '}') {
								...
								if (
									/^\s*}/.test(
										r.getLine(s.row).slice(s.column)
									)
								)
									return;
			...
			var r = e('../lib/oop'),
				...
				o = function() {
					...
					var e =
						...
						n =
							'for|if|case|capture|unless|tablerow|marker|comment',
