					...
					'#annotations': [
						{
							...
							push: [
								{
									token:
										'punctuation.definition.annotation-arguments.end.vala',
									regex: '\\)',
									next: 'pop'
								},
								{
								...
								{
									token:
										'punctuation.seperator.property.vala',
									regex: ','
								},
								{
									defaultToken:
					...
					'#assertions': [
						{
							...
							push: [
								...
								{
									token:
										'keyword.operator.assert.expression-seperator.vala',
									regex: ':'
								},
								{ include: '#code' },
								{
					...
					'#object-types': [
						...
						},
						{
							...
							push: [
								...
								{
									defaultToken:
										'storage.type.object.array.vala'
								}
							]
						},
						{
