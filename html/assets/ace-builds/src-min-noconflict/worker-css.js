		...
		(function() {
			...
			(function() {
				...
				function isNameChar(e) {
					return (
						e !== null && (isNameStart(e) || /[0-9\-\\]/.test(e))
					);
				}
								...
								_media: function() {
									...
									for (;;)
										if (e.peek() == Tokens.PAGE_SYM)
											...
											e.peek() == Tokens.FONT_FACE_SYM
										)
											this._font_face();
										else if (
											e.peek() == Tokens.VIEWPORT_SYM
										)
											this._viewport();
				...
				var Properties = {
					...
					azimuth: function(e) {
						...
						ValidationTypes.isAny(e, t) ||
							...
							ValidationTypes.isAny(e, n) &&
								((i = !0),
								r || ValidationTypes.isAny(e, 'behind')));
						if (e.hasNext())
							throw ((s = e.next()),
							i
								? new ValidationError(
					...
					'user-modify':
						'read-only | read-write | write-only | inherit',
					'user-select':
					...
					_getToken: function(e) {
						...
						while (t) {
							switch (t) {
								...
								case '-':
									n.peek() == '-'
										? (r = this.htmlCommentEndToken(
												t,
												i,
												s
										  ))
										: isNameStart(n.peek())
										? (r = this.identOrFunctionToken(
												t,
												i,
												s
										  ))
						...
						'<shadow>': function(e) {
							...
							if (e.hasNext()) {
								ValidationTypes.isAny(e, 'inset') && (r = !0),
									ValidationTypes.isAny(e, '<color>') &&
										(i = !0);
								while (
									ValidationTypes.isAny(e, '<length>') &&
									n < 4
								)
									n++;
								e.hasNext() &&
		...
		var util = {
			isArray: function(e) {
				return (
					Array.isArray(e) ||
					(typeof e == 'object' &&
						objectToString(e) === '[object Array]')
				);
			},
			isDate: function(e) {
				return (
					typeof e == 'object' &&
					objectToString(e) === '[object Date]'
				);
			},
			isRegExp: function(e) {
				return (
					typeof e == 'object' &&
					objectToString(e) === '[object RegExp]'
				);
			},
		...
		(Reporter.prototype = {
					...
					e.addListener('startrule', function() {
						...
						e.addListener('property', function(e) {
							/\-(moz|o|webkit)(?:\-(?:linear|radial))\-gradient/i.test(
								...
								? (r[RegExp.$1] = 1)
								: /\-webkit\-gradient/i.test(e.value) &&
								  (r.oldWebkit = 1);
						}),
						e.addListener('endrule', function(e) {
							var i = [];
							r.moz || i.push('Firefox 3.6+'),
								r.webkit ||
									i.push('Webkit (Safari 5+, Chrome)'),
								r.oldWebkit ||
									i.push('Old Webkit (Safari 4+, Chrome)'),
			...
			CSSLint.addRule({
				...
				init: function(e, t) {
					...
					e.addListener('property', function(e) {
						e.important === !0 &&
							(r++,
							t.report('Use of !important', e.line, e.col, n));
					}),
						e.addListener('endstylesheet', function() {
							t.stat('important', r),
								r >= 10 &&
			...
			CSSLint.addRule({
				...
				init: function(e, t) {
					...
					e.addListener('property', function(e) {
						e.invalid &&
							t.report(e.invalid.message, e.line, e.col, n);
					});
				}
			}),
			CSSLint.addRule({
					...
					e.addListener('startrule', function(e) {
						...
						for (o = 0; o < r.length; o++)
							(i = r[o]),
								...
								s.elementName === '*' &&
									t.report(n.desc, s.line, s.col, n);
					});
				}
			}),
			CSSLint.addRule({
