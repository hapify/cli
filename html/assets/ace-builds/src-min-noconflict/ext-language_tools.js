								...
								e.identifierRegexps &&
									e.identifierRegexps.forEach(
										function(e) {
											!r &&
												e &&
												(r = this.retrievePrecedingIdentifier(
													n,
													t.column,
													e
												));
				...
				(this.$init = function() {
					...
					(this.showDocTooltip = function(e) {
						this.tooltipNode ||
							...
							(this.tooltipNode.onblur = this.blurListener.bind(
								this
							)),
			...
			e('../config').defineOptions(g.prototype, 'editor', {
				enableBasicAutocompletion: {
					set: function(e) {
						e
							? (this.completers ||
									(this.completers = Array.isArray(e)
										? e
										: c),
