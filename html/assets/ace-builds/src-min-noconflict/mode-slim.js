					...
					(this.lineCommentStart = '#'),
						...
						(this.getNextLineIndent = function(t, n, r) {
							var i = this.$getIndent(n),
								s = this.getTokenizer().getLineTokens(n, t)
									.tokens;
							return (
								(!s.length ||
									s[s.length - 1].type !== 'comment') &&
									t === 'start' &&
									e.test(n) &&
									(i += r),
								i
			...
			r.inherits(l, i),
				function() {
					(this.lineCommentStart = '//'),
						...
						(this.getCompletions = function(e, t, n, r) {
							return this.$completer.getCompletions(
								'ruleset',
								t,
								n,
								r
		...
		function(e, t, n) {
			...
			var r = e('../lib/oop'),
				...
				f = (t.constantNumericHex = {
					token: 'constant.numeric',
					regex:
						'0[xX][0-9a-fA-F](?:[0-9a-fA-F]|_(?=[0-9a-fA-F]))*\\b'
				}),
