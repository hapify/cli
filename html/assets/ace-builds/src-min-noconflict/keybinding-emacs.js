				...
				(this.enter = function(e, t) {
					...
					(this.highlight = function(e, t) {
						var n = (e.$occurHighlight =
							e.$occurHighlight ||
							e.addDynamicMarker(
								new u(null, 'ace_occur-highlight', 'text')
							));
		...
		function(e, t, n) {
			...
			a.inherits(f, u),
				function() {
					(this.isOccurHandler = !0),
						(this.attach = function(e) {
							u.call(this, o, e.commands.platform),
								(this.$editor = e);
						});
				...
				(f.installIn = function(e) {
					var t = new this();
					e.keyBinding.addKeyboardHandler(t),
						e.commands.addCommands(o);
				}),
			...
			(t.iSearchStartCommands = [
				{
					...
					exec: function(e, t) {
						r.loadModule(
							['core', 'ace/incremental_search'],
							function(n) {
								var r = (n.iSearch =
									n.iSearch || new n.IncrementalSearch());
								r.activate(e, t.backwards),
									t.jumpToFirstMatch && r.next(t);
							}
						);
					},
					readOnly: !0
				...
				(t.iSearchCommands = [
					...
					},
					{
						...
						exec: function(e) {
							var t = e.$editor,
								n = t.selection.getRangeOfMovements(function(
									e
								) {
					...
					},
					{
						...
						exec: function(e) {
							...
							e.deactivate(!1),
								r.forEach(
									t.selection.addRange.bind(t.selection)
								);
						}
					},
					{
				...
				function() {
					(this.activate = function(e, t) {
						...
						(this.deactivate = function(e) {
							this.cancelSearch(e);
							var t = this.$editor;
							t.keyBinding.removeKeyboardHandler(
								this.$keyboardHandler
							),
						...
						(this.cancelSearch = function(e) {
							...
							return (
								...
								e
									...
									: t.pushEmacsMark &&
									  t.pushEmacsMark(this.$startPos, !1),
								this.highlight(null),
						...
						(this.highlightAndFindWithNeedle = function(e, t) {
							...
							return (
								s &&
									(n.backwards &&
										(s = i.fromPoints(s.end, s.start)),
									this.$editor.selection.setRange(
										i.fromPoints(
											o ? this.$startPos : s.end,
											s.end
										)
									),
						...
						(this.addString = function(e) {
							return this.highlightAndFindWithNeedle(!1, function(
								t
							) {
								if (!l(t)) return t + e;
								var n = c(t);
						...
						(this.next = function(e) {
							return (
								...
								this.highlightAndFindWithNeedle(!0, function(
									t
								) {
									return e.useCurrentOrPrevSearch &&
										t.length === 0
										? this.$prevNeedle || ''
										: t;
								})
				...
				useIncrementalSearch: {
					set: function(e) {
						this.keyBinding.$handlers.forEach(function(t) {
							t.setupIncrementalSearch &&
								t.setupIncrementalSearch(this, e);
						}),
		...
		function(e, t, n) {
						...
						return (
							e &&
								i.splice(
									s,
									1,
									'row' in e && 'column' in e ? e : undefined
								),
							o
						);
					}),
					...
					exchangePointAndMark: {
						exec: function(t, n) {
							...
							if (n.count) {
								...
								r.clearSelection(),
									r.moveCursorToPosition(
										t.emacsMarkForSelection(i)
									);
							} else
							...
							t.killRing.add(e.getCopyText()),
								setTimeout(function() {
									...
									(e.$handlesEmacsOnCopy = !1),
										e.inMultiSelectMode
											? e.forEachSelection({ exec: t })
											: t(),
										(e.session.$emacsMarkRing = n.concat(
											r.reverse()
										));
								}, 0);
						},
			...
			(d.yank.isYank = !0),
				...
				(t.killRing = {
					...
					pop: function() {
						return (
							this.$data.length > 1 && this.$data.pop(),
							this.get()
						);
					},
					rotate: function() {
