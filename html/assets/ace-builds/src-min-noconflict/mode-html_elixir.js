					...
					(this.$rules = {
						start: [
							...
							},
							{
								...
								comment:
									'@doc with heredocs is treated as documentation'
							},
							{
								token: 'comment.documentation.heredoc',
								regex: '@(?:module|type)?doc ~[A-Z]"""',
							...
							},
							{
								...
								comment:
									'@doc false is treated as documentation'
							},
							{
								...
								comment:
									'@doc with string is treated as documentation'
							},
							{
							...
							},
							{
								...
								regex:
									'\\b__(?:CALLER|ENV|MODULE|DIR)__\\b(?![?!])'
							},
							{
								token: [
							...
							},
							{
								...
								push: [
									...
									{
										defaultToken:
											'constant.other.symbol.single-quoted.elixir'
									}
								]
							},
							{
							...
							},
							{
								...
								comment:
									'single quoted string (allows for interpolation)'
							},
							{
								token:
									'punctuation.definition.string.begin.elixir',
							...
							},
							{
								...
								push: [
									...
									{
										defaultToken:
											'string.quoted.other.literal.upper.elixir'
									}
								],
								comment: 'Double-quoted heredocs sigils'
							},
							...
							{
								token:
									'keyword.operator.assignment.augmented.elixir',
								regex: '\\+=|\\-=|\\|\\|=|~=|&&='
							},
							{
						...
						'#regex_sub': [
							...
							{
								token:
									'punctuation.definition.character-class.elixir',
								regex: '\\[(?:\\^?\\])?',
								push: [
									{
										token:
							...
							},
							{
								...
								push: [
									{
										token:
											'punctuation.definition.group.elixir',
										regex: '\\)',
										next: 'pop'
									},
									{ include: '#regex_sub' },
		...
		function(e, t, n) {
			...
			var r = e('../lib/oop'),
				...
				o = function() {
					...
					this.embedRules(s, 'elixir-', t, ['start']),
						this.normalizeRules();
				};
