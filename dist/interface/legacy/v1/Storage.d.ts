declare type Access = 'admin' | 'owner' | 'auth' | 'guest';
interface Accesses {
    create: Access;
    read: Access;
    update: Access;
...
declare type FieldType = 'boolean' | 'number' | 'string' | 'datetime' | 'entity' | 'object' | 'file';
declare type FieldSubType = 'integer' | 'float' | 'latitude' | 'longitude' | 'email' | 'password' | 'url' | 'text' | 'rich' | 'date' | 'time' | 'image' | 'video' | 'audio' | 'document';
...
declare type CompactFieldBooleanProperty = 'primary' | 'unique' | 'label' | 'nullable' | 'multiple' | 'embedded' | 'searchable' | 'sortable' | 'hidden' | 'internal' | 'restricted' | 'ownership';
export {};
