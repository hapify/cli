...
let DotGeneratorService = class DotGeneratorService {
    /**
     * Constructor
     */
    constructor() {
    ...
    one(model, template) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const templateFunction = dot_1.default.template(template.content);
...
DotGeneratorService = __decorate([
    typedi_1.Service(),
    __metadata("design:paramtypes", [])
], DotGeneratorService);
exports.DotGeneratorService = DotGeneratorService;
